---
description: Research codebase by spawning parallel sub-agents
subtask: true
---
...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **For previous research:**
   - Use the **research-locator** agent to discover existing research documents in `specs/researches/` about the topic
   - Use the **research-analyzer** agent to extract key insights from specific research documents (only the most relevant ones)
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: [Repository name]
     ...
     ## Related Research
     [Links to other research documents in specs/researches/]
...
- The specs/researches/ directory provides historical context to supplement live findings
...
- Explore the specs/researches/ directory for historical context
